...
//            realtimeChartX, realtimeChartY, realtimeChartZ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        float height = 0;
        float thickness= 0;
        XYZGraphs xyzGraphs = new XYZGraphs(this, Gyroscope.this);
        Notification notification = new Notification(Gyroscope.this, this);
...
//        realtimeChartZ = (LineChart) findViewById(R.id.realtimeSeismographZ);
        ...
        xyzGraphs.realtimeGraph(openGLViewD1, pos1, openGLViewD2, pos2, databaseLogging);
