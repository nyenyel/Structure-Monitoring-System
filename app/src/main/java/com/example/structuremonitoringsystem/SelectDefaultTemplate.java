...
public class SelectDefaultTemplate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_select_default_template);
        ...
        showItemList = new ShowItemList(SelectDefaultTemplate.this);
