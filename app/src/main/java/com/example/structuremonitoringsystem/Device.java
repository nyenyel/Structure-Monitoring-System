...
public class Device extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        XYZGraphs xyzGraphs = new XYZGraphs(this, Device.this);
...
//        Log.e("Number of Device", "" + x);
        ...
        ShowItemList showItemList = new ShowItemList(Device.this);
        showItemList.showDevices(recyclerView);

        addBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Device.this, DeviceSetup.class);
